...
public class HelloAspect {
	...
	/**
	 * Pointcut 定义Pointcut，Pointcut的名称为hello()，此方法没有返回值和参数 该方法就是一个标识，不进行调用
	 */
	@Pointcut(value = "execution(* lxy.demo.hello.*.*(..))")
	public void hello() {
	}
	...
	@AfterThrowing(value = "hello()", throwing = "ex")
	 ...
	 * @param joinPoint
	 */
	@AfterReturning(value = "hello()", returning = "retVal")
